# La Liga Goal and Shot Creation Statistics

This folder contains La Liga Goal and Shot Creation statistics scraped from FBREF.
...
`GCA` | Goal-creating actions (The two offensive actions directly leading to a goal, such as passes, take-ons, and drawing fouls.)
