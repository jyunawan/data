# Bundesliga Pass Types Statistics

This folder contains Bundesliga Pass Types Statistics scraped from FBREF.
...
`Dead` | Dead-ball passes (Includes free kicks, corner kicks, kick off, throw-ins, and goal kicks)
